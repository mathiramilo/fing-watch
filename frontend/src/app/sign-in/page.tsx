...
import { Register } from '@/app/services/authorization_state'
    ...
    <main className="w-[90%] mx-auto sm:w-full sm:px-12 pt-48">
      ...
      <section className="w-full max-w-4xl mx-auto bg-black/40 backdrop-blur-3xl p-10 rounded-md mb-20">
        ...
        <form>
          ...
          <button type='button' className="bg-white/10 text-white/80 font-bold px-12 py-3 rounded-md hover:bg-white/20 hover:text-white transition-colors" onClick={signIn}>
            Sign In
          </button>
        </form>
